                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="sandbox" class="form-control">
                                <option value="1"
                                    {{ old('sandbox', $paymentMethod->sandbox) == '1' ? 'selected' : null }}>Sandbox
                                </option>
                                <option value="0"
                                    {{ old('sandbox', $paymentMethod->sandbox) == '0' ? 'selected' : null }}>Live</option>
                            </select>
                            @error('sandbox')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="1"
                                    {{ old('status', $paymentMethod->status) == '1' ? 'selected' : null }}>Active</option>
                                <option value="0"
                                    {{ old('status', $paymentMethod->status) == '0' ? 'selected' : null }}>Inactive
                                </option>
                            </select>
                            @error('status')
                                <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="merchant_email"
                                value="{{ old('merchant_email', $paymentMethod->merchant_email) }}" class="form-control">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" value="{{ old('username', $paymentMethod->username) }}" class="form-control">
                            @error('username')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="password" name="user_password" value="{{ old('user_password', $paymentMethod->user_password) }}"
                                class="form-control">
                            @error('user_password')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="signature" value="{{ old('signature', $paymentMethod->signature) }}" class="form-control">
                            @error('signature')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="client_id"
                                value="{{ old('client_id', $paymentMethod->client_id) }}" class="form-control">
                            @error('client_id')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="client_secret"
                                value="{{ old('client_secret', $paymentMethod->client_secret) }}" class="form-control">
                            @error('client_secret')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="sb_username" value="{{ old('sb_username', $paymentMethod->sb_username) }}"
                                class="form-control">
                            @error('sb_username')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="password" name="sb_user_password" value="{{ old('sb_user_password', $paymentMethod->sb_user_password) }}"
                                class="form-control">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="sb_signature" value="{{ old('sb_signature', $paymentMethod->sb_signature) }}"
                                class="form-control">
                            @error('sb_signature')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
